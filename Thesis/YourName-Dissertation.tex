%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     filename  = "Subramanya-Dissertation.tex",
%     version   = "0.0.1",
%     date      = "01/01/2016",
%     authors   = "Subramanya Umashankar,
%     copyright = "Subramanya Umashankar",
%     address   = "Michelangelostrasse 01 Dresden Germany",
%     telephone = "+49 15175232424",
%     email     = "subramanyaumashankar@icloud.com",
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Change History:
